...
public class AudioManager : MonoBehaviour
{
    ...
    public enum Sfx { Dead, Hit, LevelUp = 3, Lose, Melee, Range = 7, Select, Win,Lightning,Bossdead = 12,FireballShoot,FireballExplode,Treasuremusic0,Treasuremusic1,Treasuremusic2,Success,KnifeSquirl,AxeSquirl,ExpPickUp,GoldPickUp,Dash, warning}
