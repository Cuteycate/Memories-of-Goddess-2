...
public class BossEnemy : MonoBehaviour
{
    ...
    // Item Drop when die
    public GameObject ItemDropDead;
    ...
    public void Init(BossSpawner.SpawnData Data, bool CanfireRight)
    {
    ...
    void Dead()
    {
        Instantiate(ItemDropDead, transform.position, Quaternion.identity);
